# House Price Analysis in Taiwan - Test Script
# Author: Stella Zhang
# Date: 22 Sep 2024

# Description:
# This script performs house price analysis in Taiwan using various machine learning models, 
# including Linear Regression, Ridge Regression, Lasso Regression, Random Forest, SVM, and XGBoost.
# It also includes data visualizations and feature importance analysis.
# Ensure the required packages are installed before running this script.
# The dataset used is "real-estate-taiwan.csv".

# Note: Make sure the dataset "real-estate-taiwan.csv" is in the same directory as this script.
...
# Load the data
# Make sure the "real-estate-taiwan.csv" file is in the same directory as this script
...
ridge_pred <- predict(ridge_model, s = ridge_model$lambda.min, newx = as.matrix(x_test))
